...
<div class="left">
    ...
    <section class="title">
        <h1 style="margin-left: 100px; margin-top: 40px;">Editar Clinica</h1>
    </section>
    ...
    <section class="clinicas">
        ...
        <div class="container">
            ...
            <form action="/Editar_Clinica" methode="Post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                             <input type="text" name="nif" value="{{$data['Nif']}}" class="form-control" placeholder="Buscar..">
                        </div>  
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                             <input type="text"  name="prescriptor" value="{{$data['Prescriptor']}}" class="form-control" placeholder="Buscar..">
                        </div>  
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                             <input type="text" name="direccion"  value="{{$data['Direccion']}}" class="form-control" placeholder="Buscar..">
                        </div>  
            ...
            <a style="text-decoration: none; color: white;" name = "cancel" href="{{url('/Clinicas')}}"><button class="btn btn-secondary" id="agregar_cliente" style="margin-top: -5px; width:120px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
