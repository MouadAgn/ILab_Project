...
<header>
    ...
    <section class="clinicas">
        ...
        <div class="container">
            ...
            <form action="/AgregarInforme" methode="Post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                            ...
                            <div class="input-group">
                                 <input type="date" name="fechaenvio" class="form-control" placeholder="Buscar..">
                            </div>  
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                             <input type="text" name="horaenvio" class="form-control" placeholder="Buscar..">
                        </div>  
                ...
                <div class="row">
                    <div class="col-md-3">
                        <label for="dni">Nombre y Apellidos</label>
                        <div class="input-group">
